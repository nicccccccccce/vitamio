...
public class MediaController extends FrameLayout {
    ...
    private double currentMinutes;//当播放时长
    private VideoView mVideoView;
    private ProgressBar mProgressBar;
    private TextView downloadRateView;//下载速率
    private TextView loadRateView;//下载百分比
    private TextView playError;//视频加载异常
    private LinearLayout play_load_lay;//视频加载
    private ImageView play_default_img;//视频预设画面
    private OnMediaPlayerButtonListener mOnMediaPlayerButtonListener;
    private ImageButton mScaleButton;
    private OnMediaPlayerScaleButtonListener mOnMediaPlayerScaleButtonListener;

    public void setOnMediaPlayerScaleButtonListener(OnMediaPlayerScaleButtonListener mOnMediaPlayerScaleButtonListener) {
        this.mOnMediaPlayerScaleButtonListener = mOnMediaPlayerScaleButtonListener;
    }


    public void setOnMediaPlayerButtonListener(OnMediaPlayerButtonListener mOnMediaPlayerButtonListener) {
        this.mOnMediaPlayerButtonListener = mOnMediaPlayerButtonListener;
    }
...
//    }
    ...
    public LinearLayout getPlay_load_lay() {
        return play_load_lay;
    }

    public ImageView getPlay_default_img() {
        return play_default_img;
    }

    public TextView getPlayError() {
        return playError;
    }

    public static int getsDefaultTimeout() {
...
//            show(sDefaultTimeout);
            if (mOnMediaPlayerButtonListener != null)
                mOnMediaPlayerButtonListener.onClick(v);
        }
    };
...
//            doPauseResume();
//            show(sDefaultTimeout);
            if (mOnMediaPlayerScaleButtonListener != null)
                mOnMediaPlayerScaleButtonListener.onClick(v);
        }
    };
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            setCurrentMinutes(StringUtils.generateMinutes(newposition));
            if (mInstantSeeking)
    ...
    private void initControllerView(View v) {
        ...
        mScaleButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_play_scale", "id", mContext.getPackageName()));
    ...
    /*protected FrameLayout makeVideoView() {
        return (FrameLayout) ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("common_video_view", "layout", mContext.getPackageName()), this);
    }*/

    private void initVideoView(View v) {
//        FrameLayout frame_lay = (FrameLayout) v.findViewById(getResources().getIdentifier("frame_lay", "id", mContext.getPackageName()));
        play_load_lay = (LinearLayout) v.findViewById(getResources().getIdentifier("play_load_hint_lay", "id", mContext.getPackageName()));
        mVideoView = (VideoView) v.findViewById(getResources().getIdentifier("surface_video_view", "id", mContext.getPackageName()));
        mProgressBar = (ProgressBar) v.findViewById(getResources().getIdentifier("probar", "id", mContext.getPackageName()));
        downloadRateView = (TextView) v.findViewById(getResources().getIdentifier("download_rate", "id", mContext.getPackageName()));
        loadRateView = (TextView) v.findViewById(getResources().getIdentifier("load_rate", "id", mContext.getPackageName()));
        playError = (TextView) v.findViewById(getResources().getIdentifier("play_error", "id", mContext.getPackageName()));
        play_default_img = (ImageView) v.findViewById(getResources().getIdentifier("play_default_img", "id", mContext.getPackageName()));
    }
...
//                mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY, anchorRect.left, anchorRect.bottom);
    ...
    private long setProgress() {
        ...
        if (mCurrentTime != null) {
            setCurrentMinutes(StringUtils.generateMinutes(position));
    ...
    public interface OnMediaPlayerButtonListener {
        void onClick(View v);
    }

    public interface OnMediaPlayerScaleButtonListener {
        void onClick(View v);
    }
}
